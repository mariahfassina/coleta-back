...
// 1. Importamos a biblioteca principal do Brevo aqui
...
// ========================================================
// FUNÇÃO UPDATEPAGINA (COM A CORREÇÃO FINAL)
// ========================================================
    ...
    if (paginaAtualizada.slug === 'home-cronograma') {
      ...
      try {
        ...
        if (subscriptions.length === 0) {
          ...
          // 3. Pegamos a chave de API direto do process.env
          const apiKey = apiInstance.authentications['api-key'];
          apiKey.apiKey = process.env.BREVO_API_KEY;

          // 4. Montamos o e-mail usando o modelo da SDK
...
Secretaria de Meio Ambiente – Projeto Coleta Amiga</p>
          ...
          // 5. Enviamos o e-mail usando a instância da SDK
